...
from services.extraction.lsp.manager import LanguageServerManager
from services.extraction.lsp.protocol import LspRange
from services.extraction.lsp.symbols import RawSymbol, find_enclosing
...
class CallGraphResolver:
    ...
    def callees(
        ...
        from services.extraction.parsers.syntax import Scope
